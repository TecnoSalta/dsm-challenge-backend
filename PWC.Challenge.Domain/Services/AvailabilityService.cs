...
public class AvailabilityService : IAvailabilityService
{
    ...
    public async Task<bool> IsCarAvailableAsync(Guid carId, DateOnly startDate, DateOnly endDate, Guid? excludedRentalId = null)
    {
        ...
        if (await HasRentalEndingBeforeStartAsync(carId, startDate, excludedRentalId))
            return false;
    ...
    {
        var car = await _carRepository.GetByIdAsync(carId, true);
        if (car == null)
            return false;

        return car.IsInServicePeriod(startDate, endDate);
    }
    ...
    private async Task<bool> HasRentalEndingBeforeStartAsync(Guid carId, DateOnly startDate, Guid? excludedRentalId = null)
    {
